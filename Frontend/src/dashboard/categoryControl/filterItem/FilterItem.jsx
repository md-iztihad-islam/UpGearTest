...
function FilterItem() {
    ...
    const cards = [
        {
            path: "add-filter-item",
            title: "Add Filter-item",
            icon: Plus,
            description: "Create new filter items",
            color: "from-blue-600 to-blue-700"
        },
        // {
        //     path: "manage-filter-item",
        //     title: "Manage Filter-item",
        //     icon: Settings,
        //     description: "View and edit filter items",
