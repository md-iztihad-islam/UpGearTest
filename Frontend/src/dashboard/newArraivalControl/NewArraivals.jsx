...
function NewArrivals() {
    ...
    const cards = [
        {
            path: "add-to-new-arraivals",
            title: "Add New Arrivals",
            icon: Plus,
            description: "Add products to new arrivals",
        ...
        },
        {
            ...
            icon: Settings,
            description: "View and manage arrivals",
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-gray-400 text-lg">
                        Manage your latest product arrivals
                    </p>
                </div>
                    ...
                    {cards.map((card) => {
                        ...
                        return (
                            <div
                                ...
                                className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 hover:border-gray-600 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/20"
                            >
                                ...
                                <div className="relative p-8 flex flex-col items-center text-center space-y-4">
                                    ...
                                    {/* Arrow indicator */}
                                    <div className="absolute bottom-4 right-4 text-gray-600 group-hover:text-emerald-400 transition-all duration-300 group-hover:translate-x-1">
                                        →
                                    </div>
                                </div>
                            </div>
